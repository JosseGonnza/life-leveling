...
public enum QuestRank {
    ...
    E("🟢", "Rutinaria", "5-15 min", 10, 15, 0, null),
    D("🔵", "Común", "30-60 min", 50, 50, 5, null),
    C("🟣", "Rara", "1-2 horas", 150, 150, 15, HPState.TIRED),
    B("🟠", "Élite", "3-5 horas", 500, 400, 20, HPState.HEALTHY),
    A("🔴", "Heroica", "Días/Hitos", 1_500, 2_000, 30, HPState.HEALTHY),
    S("🟡", "Legendaria", "Meses", 5_000, 10_000, 50, HPState.HEALTHY),
    S_PLUS("⭐", "Mítica", "1-2 años", 20_000, 50_000, 50, HPState.HEALTHY),
    S_PLUS_PLUS("🌌", "Divina", "Endgame", 100_000, 500_000, 50, HPState.HEALTHY);
    ...
    private final HPState minHPState;
    ...
    /**
     * [NUEVO] Verifica si este rango es superior o igual a otro.
     * Necesario para GateTracker.getUserQuestsCompletedInLastDays.
     */
